  ...
  return `
    <style>
      *{box-sizing:border-box}
      ...
      .columns,.holding-row{display:grid;grid-template-columns:2.25fr 1.15fr 1fr .85fr 1fr 1.55fr}.columns{height:34px;align-items:center;border:1px solid #d1dde6;border-radius:7px;background:#edf3f7}.columns div{padding:0 12px;color:#536a7c;font-size:8px;font-weight:700;letter-spacing:.09em;text-align:right}.columns div:first-child{text-align:left}
      .portfolio-grid{display:flex;flex-direction:column;gap:6px;padding-top:6px}.holding-row{height:70px;flex:none;border:1px solid #d6e0e7;border-radius:9px;overflow:hidden;background:#fff}.holding-row:nth-child(even){background:#f8fafc}.cell{min-width:0;padding:8px;border-right:1px solid #e2e8ed;display:flex;flex-direction:column;justify-content:center;line-height:1}.cell:last-child{border-right:0}.cell strong{display:block;color:#172b3d;font-size:13px;line-height:15px;font-weight:700;font-variant-numeric:tabular-nums}.cell span{display:block;margin-top:6px;color:#53697b;font-size:9px;line-height:11px}.cell small{display:block;margin-top:4px;color:#82909d;font-size:8px;line-height:10px}.asset strong{color:#0b5d96;font-size:14px;letter-spacing:.02em}.asset span{color:#243a4c;font-size:10px;font-weight:600}.numeric{text-align:right;align-items:flex-end}.positive strong{color:#28735a}.negative strong{color:#a14643}.neutral strong{color:#34495a}.weight{width:70px;height:3px;margin-top:7px;background:#dce6ec}.weight i{display:block;height:100%;background:#1593cf}.quote span,.quote small{white-space:normal;line-height:13px}
      .cell.asset{flex-direction:row;align-items:center;justify-content:flex-start;gap:8px}.company-logo{position:relative;flex:none;width:28px;height:28px;border:1px solid #cedbe5;border-radius:7px;overflow:hidden;background:#e2ecf5;color:#103858;display:flex;align-items:center;justify-content:center;font-size:12px}.company-logo img{position:absolute;inset:0;width:28px;height:28px;object-fit:contain;background:#fff}.company-text{min-width:0}.company-text span{line-height:15px;margin-top:2px}.company-text small{line-height:12px;margin-top:1px}.company-text{overflow-wrap:anywhere}
