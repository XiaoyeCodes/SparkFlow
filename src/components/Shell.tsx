              ...
              if ('disabled' in item && item.disabled) {
                return (
                  <button
                    ...
                    disabled
                    title="每日策略暂未开放"
                    className="relative flex h-9 min-w-[58px] cursor-not-allowed items-center justify-center gap-2 rounded-[6px] border border-white/[0.09] bg-[#06080b]/80 px-3 text-center text-xs font-medium text-white/32"
                  >
                    <span aria-hidden="true" className="h-1.5 w-1.5 shrink-0 rounded-full bg-white/12" />
