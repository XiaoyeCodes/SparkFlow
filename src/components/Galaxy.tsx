...
const defaultFocal: [number, number] = [0.5, 0.5];
const defaultRotation: [number, number] = [1, 0];
...
export function Galaxy({
  ...
  return <div ref={containerRef} className={`galaxy-container${className ? ` ${className}` : ''}`} {...rest} />;
}
