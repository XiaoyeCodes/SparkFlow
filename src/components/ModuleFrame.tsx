    ...
    <PageTransition>
      ...
      >
        <div className="mb-10 flex items-center justify-between gap-4">
          <div>
            <p className="mb-3 text-xs font-semibold uppercase text-white/40">{kicker}</p>
            <h1 className="max-w-4xl text-5xl font-semibold leading-[0.96] text-white md:text-7xl">{title}</h1>
          </div>
          <Link
            to="/"
